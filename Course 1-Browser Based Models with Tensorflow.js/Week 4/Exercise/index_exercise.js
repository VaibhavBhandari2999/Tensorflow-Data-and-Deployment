...
async function train() {
  ...
  model = tf.sequential({
    ...
    tf.layers.dense({ units: 5, activation: 'softmax'})//Output layer will be 3 units as we'll try to transfer learning from the 1,000 class mobile net model to handle three specific classes that we need it to do.
